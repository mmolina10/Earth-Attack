...
var Textos:String = "";
var PosX:int = 580; //así se podrá modificar mientras estes jugando.
var PosY:int = 30; //así se podrá modificar mientras estes jugando.
...
function Update()
{
if(Input.GetKeyDown(KeyCode.Return) && Dialogos < iDialogueCnt)
{
...
GUI.skin = customSkin;
if(Dialogos != iDialogueCnt){
	GUI.Box(Rect (Screen.width/2-(PosX/2), Screen.height/1.2-(PosY/2), PosX, PosY), aDialogs[Dialogos] );
}
